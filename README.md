...
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Backend](https://oo-ooo.fun/) | [![Deploy Backend Production](https://github.com/NoviceLevel/cloudflare_temp_email_apex/actions/workflows/backend_deploy.yaml/badge.svg)](https://github.com/NoviceLevel/cloudflare_temp_email_apex/actions/workflows/backend_deploy.yaml) |
